...
export default function SwapRequest() {
  ...
  const incoming = requests.filter(r => r.target_teacher_id === myTeacherId && r.status === 'pending');
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({...formData, target_teacher_id: e.target.value})}
                  ...
                  incoming.map(req => (
                    <div key={req.id} className="bg-slate-900/40 border border-slate-700/30 rounded-xl p-4 flex flex-col gap-3 group hover:border-indigo-500/30 transition-all">
                      <div className="flex justify-between items-start">
                        <div>
                          <p className="text-sm font-bold text-slate-200">From {req.requester_id}</p>
                    ...
                    <div key={req.id} className="bg-slate-900/40 border border-slate-700/30 rounded-xl p-3 flex justify-between items-center text-sm">
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-slate-300">{req.target_teacher_id || 'Anyone'}</span>
                        </div>
